...
export default class ChoiceQuestion extends Preact.Component {
    constructor(props) {
        super(props);
        this.state = {
            saving: false,
                ...
                <div className="quizResponses">
                    {this.props.quiz.responses.map((response, index) => 
                        <div className='checkbox' key={index}>
                            <label>
                                <input type='radio' name={index} checked={this.state.answers[index]} onChange={this.handleChange} disabled={this.state.saving || this.state.saved} /> {response}
